...
class Y86MachineFunctionInfo : public MachineFunctionInfo {
  ...
  /// RegSaveFrameIndex - Y86-64 vararg func register save area.
  int RegSaveFrameIndex = 0;
  /// VarArgsGPOffset - Y86-64 vararg func int reg offset.
  unsigned VarArgsGPOffset = 0;
  /// VarArgsFPOffset - Y86-64 vararg func fp reg offset.
